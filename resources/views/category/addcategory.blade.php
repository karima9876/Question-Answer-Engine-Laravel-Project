                        ...
                        <div class="col-lg-10 col-sm-10 col-xs-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Add Category Form</span>
                                            ...
                                            <div class="tab-content tabs-flat">
                                                <div class="tab-pane active" id="address-tab">
                                                    <div class="form-group has-feedback">
                                                        ...
                                                        <div class="col-lg-8 ">
                                                            <input type="text" name="categoryname" value="" placeholder="Enter Category Name" class="form-control input-inline input-medium @error('categoryname') is-invalid @enderror">
                                                             @error('categoryname')
