                    ...
                    <div style="margin-top: 10px;margin-left: 295px;" class="col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <div class="widget radius-bordered">
                                <div class="widget-header ">
                                    <span class="widget-caption">Leave an Answer</span>
                            ...
                            <div class="widget-body">
                                <div class="docs-example">
                                    <form action="{{url('answers/save').'?qqid='.$allquestion->id}}" id="accountForm" method="post" class="form-horizontal bv-form" enctype="multipart/form-data"  novalidate="novalidate">
                                    @csrf
                        ...
                        @endif
                                      <div class="form-group has-feedback">
                                                    ...
                                                    <input style="margin-top:0px" type="file"  name="afile" placeholder="Enter Files " class="form-control input-inline input-medium" >
                                        ...
                                        <div  class="form-group has-feedback">
                                            ...
                                            <div  class="col-lg-8">  
                                                    <div   class="widget-header bordered-bottom bordered-themeprimary">
                                                        ...
                                                        <textarea  id="summernote" name="acontent">{{old('acontent')}}</textarea>
