                    ...
                    <div style="margin-top: 10px;margin-left: 295px;" class="col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <div class="widget radius-bordered">
                                <div class="widget-header ">
                                    <span class="widget-caption">Update an Answer</span>
                            ...
                            <div class="widget-body">
                                <div class="docs-example">
                                    ...
                                    <form action="{{url('answers/save')}}" id="accountForm" method="post" class="form-horizontal bv-form" enctype="multipart/form-data"  novalidate="novalidate">
                                    @csrf

                                        <div class="tab-content tabs-flat">
                                            <div class="tab-pane active" id="address-tab">
                                            @if(!empty($allquestion))
                            <input type="hidden" name="id" value="{{$allquestion->id}}">
                        @endif
                                            ...
                                            <div class="form-group has-feedback">
                                                    ...
                                                    <input style="margin-top:0px" type="file"  name="afile" value="@if(!empty($allquestion->afile)) {{$allquestion->afile}} @endif" placeholder="Enter Files " class="form-control input-inline input-medium" >
                                <div class="red">{{ $errors->first('afile') }}</div>
                                @if(!empty($allquestion->afile)) {{$allquestion->afile}} @endif
                                                    </div>   
                                                </div>        
                                                <div  class="form-group has-feedback">
                                            <label class="col-lg-4 control-label"> Answer <span class="red">*</span> : </label>
                                            <div  class="col-lg-8">  
                                                    <div   class="widget-header bordered-bottom bordered-themeprimary">
                                                        ...
                                                        @if(!empty($allquestion->acontent)) {{$allquestion->acontent}} @endif
                                                        </textarea>
                                                     <div class="red">{{ $errors->first('acontent') }}</div>
