                    ...
                    <div style="margin-top: 10px;margin-left: 295px;" class="col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <div class="widget radius-bordered">
                                <div class="widget-header ">
                                    <span class="widget-caption">Leave an Reply</span>
                            ...
                            <div class="widget-body">
                                <div class="docs-example">
                                    <form action="{{url('replies/save').'?aaid='.$answer->id}}" id="accountForm" method="post" class="form-horizontal bv-form" enctype="multipart/form-data"  novalidate="novalidate">
                                    @csrf
                               ...
                               <div class="form-group has-feedback">
                                                    ...
                                                    <div class="col-lg-8">
                                                    <input style="margin-top:0px" type="file"  name="rfile" placeholder="Enter Files " class="form-control input-inline input-medium" >
