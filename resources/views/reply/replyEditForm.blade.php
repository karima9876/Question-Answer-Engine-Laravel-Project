                        ...
                        <div class="widget radius-bordered">
                            ...
                            <div class="widget-body">
                                <div class="docs-example">
                                    <form action="{{url('replies/save')}}" id="accountForm" method="post" class="form-horizontal bv-form" enctype="multipart/form-data"  novalidate="novalidate">
                                    @csrf
                            ...
                            @endif
                                ...
                                @if(!empty($replies->rfile)) {{$replies->rfile}} @endif
                                                    </div>   
                                                </div>        
                                                <div  class="form-group has-feedback">
